...
import { _useStyleTokens } from "./PlasmicStyleTokensProvider"; // plasmic-import: eDF77JsGistQwyReSVJoYU/styleTokensProvider

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: eDF77JsGistQwyReSVJoYU/projectcss
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: pNVqC8sPYPKd/css
...
function PlasmicProjectHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns__eL4Q)}>
        <div className={classNames(projectcss.all, sty.column__gx9L8)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__tbHtw)}>
          <div className={classNames(projectcss.all, sty.columns__e4Haj)}>
            <div className={classNames(projectcss.all, sty.column___2NvYm)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__tCXki)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column__rYudc)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__m82Ju)}>
                {renderPlasmicSlot({
